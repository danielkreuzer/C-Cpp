...
class wordset {
	...
	public:
		...
		void compare(wordset &other) {
			...
			cout << "- Nr. of used words in file1: " << endl << "- - " << words.size() << endl;
			cout << "- Nr. of used words in file2: " << endl << "- - " << other.words.size() << endl;
			cout << "- Sum of used words in both files: " << endl << "- - " << cunion.words.size() << endl;
			cout << "- Nr. of equal words: " << endl << "- - " << cintersect.words.size() << endl;
			cout << "- Percentage of equal words to sum of words:" << endl << "- - - "<< ((double(cintersect.words.size()) * 100.0) / double(cunion.words.size())) << "%" << " = equality key figure" << endl;
		}
